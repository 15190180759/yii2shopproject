...
class SuiteManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGroupEventsAreFired()
    {
        ...
        $this->dispatcher->addListener('test.before.user', $eventListener);
        $this->dispatcher->addListener('test.after', $eventListener);
        $this->dispatcher->addListener('test.after.user', $eventListener);
        ...
        $this->assertContains('test.before.user', $events);
        $this->assertContains('test.after', $events);
        $this->assertContains('test.after.user', $events);
    }
}
