 ...
 *
 *  * `appPath` - full path to the application, include register.php</li>
 *  * `url` - full url to the register.php entry script</li>
 *
 * In your register.php you must return an array with correct configuration for the application:
 *
 * For the simple created yii application register.php will be like this:
 *
 * ```php
 * <?php
 ...
 *     enabled:
 *         - Yii1:
 *             appPath: '/path/to/register.php'
 *             url: 'http://localhost/path/to/register.php'
 *         - \Helper\Functional
 * ```
 *
