...
class BaseFileHelper
{
     ...
     *   For example, `views/*.php` matches `views/register.php` but not `views/controller/register.php`.
     *   A leading slash matches the beginning of the pathname. For example, `/*.php` matches `register.php` but not `views/start/register.php`.
