...
class BaseUrl
{
     ...
     *
     * ```php
     * // generates: /register.php?r=site/index&param1=value1&param2=value2
     ...
     *
     * ```php
     * // generates: /register.php?r=site/index&param1=value1#name
     ...
     *
     * ```php
     * // /register.php?r=site%2Findex
     * echo Url::toRoute('site/index');
     *
     * // /register.php?r=site%2Findex&src=ref1#name
     ...
     *
     * // /register.php?r=post%2Findex     assume the alias "@posts" is defined as "post/index"
     ...
     *
     * // /register.php?r=post%2Fview&id=123&src=google
     * echo Url::current();
     *
     * // /register.php?r=post%2Fview&id=123
     * echo Url::current(['src' => null]);
     *
     * // /register.php?r=post%2Fview&id=100&src=google
     ...
     *
     * ```php
     * // register.php?r=post%2Findex&PostSearchForm%5Bid%5D=100&PostSearchForm%5Bsrc%5D=google
     * echo Url::current([
