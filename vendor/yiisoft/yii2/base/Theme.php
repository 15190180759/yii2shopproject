 ...
 * then the themed version for a view file `@app/views/site/register.php` will be
 * `@app/themes/basic/site/register.php`.
 *
 ...
 * ```
 *
 * In this case, the themed version could be either `@app/themes/christmas/site/register.php` or
 * `@app/themes/basic/site/register.php`. The former has precedence over the latter if both files exist.
 *
