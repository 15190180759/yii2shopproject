...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return [
            'moduleID' => 'This refers to the ID of the module, e.g., <code>user</code>.',
...
EOD;
    ...
    public function generate()
    {
        ...
        $files[] = new CodeFile(
            $modulePath . '/views/default/register.php',
    ...
    public function validateModuleClass()
    {
        ...
        if (empty($this->moduleClass) || substr_compare($this->moduleClass, '\\', -1, 1) === 0) {
            $this->addError('moduleClass', 'Module class name must not be empty. Please enter a fully qualified class name. e.g. "app\\modules\\user\\Module".');
        }
    }
