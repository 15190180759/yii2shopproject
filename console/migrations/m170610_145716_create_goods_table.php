 ...
 */
class m170610_145716_create_goods_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        $this->createTable('goods', [
            ...
            'is_on_sale'=>$this->integer()->defaultValue(1)->comment('是否在售（1在售，0下架）'),
            'status'=>$this->integer()->defaultValue(1)->comment('状态(1正常,0回收站)'),
