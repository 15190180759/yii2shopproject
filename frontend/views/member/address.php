...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        <h1 class="fl"><a href="../index/index.php"><?=\yii\helpers\Html::img('@web/images/logo.png')?></a></h1>
        <!-- 头部搜索 start -->
        <div class="search fl">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            foreach($addresses as $address){
                ...
                echo '<dt>'.$address->username.
                    ...
                    '</dt>';
                echo '<dd>'.
                    \yii\helpers\Html::a('修改',['member/address-edit','id'=>$address->id]).'&nbsp;'.
                    \yii\helpers\Html::a('删除',['member/address-del','id'=>$address->id]).'&nbsp;';
                    if($address->status){
                        echo \yii\helpers\Html::label('默认地址',['','id'=>$address->id]);
                    }else{
                       echo \yii\helpers\Html::a('设为默认',['member/address-default','id'=>$address->id]);
                    };
                 echo '</dd>';
        ...
        <div class="address_bd mt10">
           ...
           echo $form->field($model, 'province')->widget(\chenkby\region\Region::className(),[
                ...
                'province'=>[
                    'attribute'=>'province',
                    'items'=>\frontend\models\Region::getRegion(),
                    'options'=>['class'=>'form-control form-control-inline','prompt'=>'选择省份']
                ],
                'city'=>[
                    'attribute'=>'city',
                    'items'=>\frontend\models\Region::getRegion($model['province']),
                    'options'=>['class'=>'form-control form-control-inline','prompt'=>'选择城市']
                ],
                'district'=>[
                    'attribute'=>'district',
                    'items'=>\frontend\models\Region::getRegion($model['city']),
