 ...
 * @var yii\web\view;
 */
$this->registerCssFile('/style/list.css',['depends'=>['frontend\assets\IndexAsset']]);
?>
<!-- 头部 start -->
<div class="header w1210 bc mt15">
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl cat1"> <!-- 非首页，需要添加cat1类 -->
            ...
            <?php foreach($goodsCategories as $k=>$goodsCategory)://遍历所有商品的一级分类?>
                <div class="cat <?=$k==0?'item1':'';?>">
                    <h3><?=\yii\helpers\Html::a($goodsCategory->name)?><b></b></h3>
                    <div class="cat_detail none">
                        <?php foreach($goodsCategory->children as $k2=>$child):?>
                        <dl <?=$k2==0?'class="dl_1st"':''?>>
                            <dt><?=\yii\helpers\Html::a($child->name)?></dt>
                            <dd>
...
<div class="list w1210 bc mt10">
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                <?php foreach($goodes as $wares):?>
                    <li>
                        <dl>
                            <dt><a href="goods.html?id=<?=$wares->id?>"><?=\yii\helpers\Html::img('http://admin.yiishop.com'.$wares->logo)?></a></dt>
                            <dd class="name"><a href=""><?=$wares->brand->name?></a></dd>
                            <dd><strong><?=$wares->shop_price?></strong></dt>
                        </dl>
                    </li>
                <?php endforeach;?>
